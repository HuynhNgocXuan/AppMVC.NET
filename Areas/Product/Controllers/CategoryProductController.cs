...
{
    [Area("Product")]
    [Route("admin/category-product/category/[action]/{id?}")]
    ...
    public class CategoryProductController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Title,Description,Slug,ParentCategoryId")] CategoryProduct category)
        {
