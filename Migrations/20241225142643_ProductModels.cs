    ...
    public partial class ProductModels : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAndProduct", x => new { x.ProductID, x.CategoryID });
                    table.ForeignKey(
                        name: "FK_CategoryAndProduct_CategoryProduct_CategoryID",
                        column: x => x.CategoryID,
                        principalTable: "CategoryProduct",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CategoryAndProduct_Product_ProductID",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAndProduct_CategoryID",
